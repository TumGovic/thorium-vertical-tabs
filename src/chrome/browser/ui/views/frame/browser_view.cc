...
constexpr int kVerticalTabStripContainerViewId = 0x7a430001;

bool AreVerticalTabsEnabled() {
  return base::CommandLine::ForCurrentProcess()->HasSwitch("vertical-tabs");
}
...
BrowserView::BrowserView(std::unique_ptr<Browser> browser)
  ...
  if (AreVerticalTabsEnabled() &&
    ...
    auto vertical_tab_strip_container =
        std::make_unique<VerticalTabStripContainerView>(browser_.get());
    vertical_tab_strip_container->SetID(kVerticalTabStripContainerViewId);
...
void BrowserView::AddedToWidget() {
  ...
  views::View* vertical_tab_strip_container =
      GetViewByID(kVerticalTabStripContainerViewId);
