...
struct BrowserViewLayout::ContentsContainerLayoutResult {
  ...
  bool vertical_tab_strip_visible;
...
gfx::Size BrowserViewLayout::GetMinimumSize(const views::View* host) const {
  ...
  gfx::Size vertical_tab_strip_size(
      vertical_tab_strip_container_ && vertical_tab_strip_container_->GetVisible()
          ? vertical_tab_strip_container_->GetMinimumSize()
          : gfx::Size());
  ...
  const int min_width =
      std::max({tabstrip_size.width(), toolbar_size.width(),
                ...
                contents_size.width() + vertical_tab_strip_size.width()});
...
BrowserViewLayout::CalculateContentsContainerLayout(int top, int bottom) const {
  ...
  const bool vertical_tab_strip_visible =
      vertical_tab_strip_container_ && vertical_tab_strip_container_->GetVisible();
  gfx::Rect vertical_tab_strip_bounds;
  if (vertical_tab_strip_visible) {
    const int vertical_tab_strip_width =
        vertical_tab_strip_container_->GetPreferredSize().width();
    vertical_tab_strip_bounds =
        gfx::Rect(vertical_layout_rect_.x(), top, vertical_tab_strip_width,
                  contents_container_bounds.height());
    contents_container_bounds.set_x(contents_container_bounds.x() +
                                    vertical_tab_strip_width);
    contents_container_bounds.set_width(
        std::max(0, contents_container_bounds.width() - vertical_tab_strip_width));
  }
  ...
  if (!side_panel_visible) {
    ...
    return ContentsContainerLayoutResult{vertical_tab_strip_bounds,
                                         contents_container_bounds,
                                         gfx::Rect(),
                                         vertical_tab_strip_visible,
                                         false,
                                         false,
                                         false,
                                         gfx::Rect()};
...
void BrowserViewLayout::LayoutContentsContainerView(int top, int bottom) {
  ...
  if (vertical_tab_strip_container_) {
    SetViewVisibility(vertical_tab_strip_container_,
                      layout_result.vertical_tab_strip_visible);
    vertical_tab_strip_container_->SetBoundsRect(
        layout_result.vertical_tab_strip_bounds);
  }
